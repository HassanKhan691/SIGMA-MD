...
global.owner = process.env.OWNER_NUMBER  || '923216520225' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923216520225" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '21_07_2024_SIGMA_MD_nzSSRgW0_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'BLACK_EAGLE',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `BLACK EAGLE`, // ADD YOUR NAME
